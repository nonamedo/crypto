...
{
    internal class GetTokenBalanceCommand: ICommand
    {
        private readonly ICryptoService _service;
        private readonly IInputOutput _io;

        public GetTokenBalanceCommand(ICryptoService service, IInputOutput io)
        {
            _service = service;
            _io = io;
        }
        ...
        public void Execute()
        {
            ...
            decimal balance = _service.GetTokenBalanceAsync(acc, contract).GetAwaiter().GetResult();
